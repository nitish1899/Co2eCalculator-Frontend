            ...
            >
              {({ handleChange, handleBlur, handleSubmit, values, errors }) => (
                <View className="pb-[50px]">
                  ...
                  <TouchableOpacity onPress={toggleAdditionalDetails} className="flex items-center justify-center">
                    <Text className="text-xl font-[500] text-center">
                  ...
                  {showAdditionalDetails && (
                    <>
                      ...
                      <View className="flex items-center">
                        <Text className="text-xl mt-2  text-center">Mobilisation Distance</Text>
                        <TextInput
                          className="w-[76%] my-2 rounded-xl border-2 text-black-200 text-lg font-semibold pl-[30px]"
                      ...
                      <Text className="text-xl mt-2 text-center">DeMobilisation Distance</Text>
                      <TextInput
