...
import { ImageBackground, KeyboardAvoidingView, ScrollView, Text, View, Button, Animated, Dimensions, Platform, Image } from 'react-native';
...
<body>
  ...
  return (
    <View className="flex-1">
      <ImageBackground source={require("../../assets/images/bg4.jpg")} resizeMode="cover" className="flex-1 justify-center items-center">
        <View className="w-[105%] h-[13%] bg-[#00bcd4] rounded-b-[100px] flex-row items-center justify-center">
          <Text className="mt-12 text-2xl ml-16">{`नमस्ते ${userInfo ? userInfo.userName : "Name"}`}</Text>
          <View className="mt-10 ml-12 items-center justify-center h-10 w-10 bg-white rounded-full">
            <FontAwesome5 name="cloud-moon" size={24} color="black" />
          </View>
        </View>

        <KeyboardAvoidingView className="flex-1 w-full mt-10 " behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
          <ScrollView contentContainerStyle={{ alignItems: 'center' }}>
            <Text className="text-2xl mb-2">Total Carbon Footprint</Text>
            <View className="mt-2 h-10 w-64 bg-[#f0f0f0] items-center justify-center">
              <Text className="text-xl font-semibold">{result ? `${result.co2Emission} kg` : 'Loading...'}</Text>
            </View>

            <View className="h-8 w-64 bg-[#f0f0f0] items-center justify-center">
              <Text className="text-xl">Equivalent to</Text>
            </View>
            <View className="h-10 w-64 bg-[#f0f0f0] items-center justify-center">
              <Text className="text-xl font-semibold">{result ? `${(result.co2Emission / 1000).toFixed(1)} unit` : 'Loading...'}</Text>
            </View>

            {resulterror && (
              <View className="mt-5 items-center justify-center">
                <Text className="text-xl text-red-600">{resulterror}</Text>
              </View>
            )}
            ...
            <View className="h-40 relative ">
              ...
              {showText && (
                <View className="mt-14 absolute w-64 ml-[-22] rounded-2xl items-center justify-center">
                  <View className="flex-row items-center">
                    <Text className="text-xl">{`Plant ${result ? Math.ceil((result.co2Emission / 1000) * 12) : '...'} trees`}</Text>
                    <Image
                      source={require("../../assets/images/mango2.png")}
                      className="w-8 h-5"
                    />
                    <Text className="text-xl"> to offset </Text>
                  </View>
                  <Text className="text-xl mx-2">for your CO2 Footprint</Text>
                </View>
              )}
            ...
            <View className="w-[70%] self-center">
              <Button title="Print" onPress={print} color="#4CAF50"/>
              <View className="h-4" />
              <Button title="Print to PDF file" onPress={printToFile} color="#4CAF50" />
              {Platform.OS === 'ios' && (
                <>
                  <View className="h-4"/>
                  <Button title="Select printer" onPress={selectPrinter} color="#4CAF50" />
                  <View className="h-4" />
                  {selectedPrinter ? (
                    <Text className="text-center text-lg text-gray-800 mt-2">{`Selected printer: ${selectedPrinter.name}`}</Text>
                  ) : undefined}
                </>
              )}
            </View>
            ...
            <View className="mt-20">
              <Text className="text-center text-green-500 font-semibold text-xl">#Save Environment #Green generation</Text>
            </View>
          </ScrollView>
...
//                   <Image
//                     source={require("../../assets/images/image 10.png")}
//                     className="w-8 h-4 absolute top-24 left-40"
//                   />
//                 </View>
//               </Animated.View>
